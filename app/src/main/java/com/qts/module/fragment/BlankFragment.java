package com.qts.module.fragment;
...
import com.qts.module.activity.ContentActivity;
...
public class BlankFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        QtsAd.getInstance().loadBannerFragment(requireActivity(), idBanner, view1, new AdCallback() {
            @Override
        ...
        QtsAd.getInstance().loadNativeAd(requireActivity(), getString(R.string.admod_native_id), com.ads.qts.R.layout.custom_native_admob_free_size, flPlaceHolder, shimmerFrameLayout, null);
    }
}