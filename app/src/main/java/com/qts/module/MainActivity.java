    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLoad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                QtsAd.getInstance().getInterstitialAds(MainActivity.this, BuildConfig.ad_interstitial_splash, new AdCallback() {
                    @Override
        ...
        btnShow.setOnClickListener(v -> QtsAd.getInstance().forceShowInterstitial(MainActivity.this, mInterstitialAd, new AdCallback() {
        }, true));

        // Banner Ads
        QtsAd.getInstance().loadBanner(this, BuildConfig.ad_banner);
        /*QtsAd.getInstance().loadCollapsibleBanner(this, BuildConfig.ad_banner, AppConstant.CollapsibleGravity.BOTTOM, new AdCallback());*/

        // Native Ads: Load And Show
        QtsAd.getInstance().loadNativeAd(this, BuildConfig.ad_native, R.layout.native_large, frAds, shimmerAds, new AdCallback() {
            @Override
        ...
        // Native Ads: Load
        QtsAd.getInstance().loadNativeAdResultCallback(this, BuildConfig.ad_native, R.layout.native_large, new AdCallback() {
            @Override
        ...
        // Native Ads: Show
        if (mApNativeAd != null) {
            QtsAd.getInstance().populateNativeAdView(this, mApNativeAd, frAds, shimmerAds);
        }
        ...
        btnLoadReward.setOnClickListener(v -> {
            QtsAd.getInstance().initRewardAds(this, BuildConfig.ad_reward, new AdCallback() {
                @Override
        ...
        btnShowReward.setOnClickListener(v -> {
            isEarn = false;
            QtsAd.getInstance().showRewardAds(MainActivity.this, rewardedAds, new RewardCallback() {
                @Override
