...
public class QtsAdConfig {
    ...
    public QtsAdConfig(Application application) {
        this.application = application;
    }

    public QtsAdConfig(Application application, int mediationProvider, String environment) {
