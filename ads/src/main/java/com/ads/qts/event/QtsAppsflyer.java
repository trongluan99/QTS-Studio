...
public class QtsAppsflyer {
    private static final String TAG = "QtsAppsflyer";
    private Context context;
    private static QtsAppsflyer qtsAppsflyer;
    public static boolean enableAppsflyer = false;

    public QtsAppsflyer() {
    }

    public static QtsAppsflyer getInstance(){
        if (qtsAppsflyer ==null)
            qtsAppsflyer = new QtsAppsflyer();
        return qtsAppsflyer;
    }
