...
public class QtsLogEventManager {

    private static final String TAG = "QtsLogEventManager";
    ...
    public static void logPaidAdImpression(Context context, AdValue adValue, String adUnitId, String mediationAdapterClassName, AdType adType) {
        logEventWithAds(context, (float) adValue.getValueMicros(), adValue.getPrecisionType(), adUnitId, mediationAdapterClassName, QtsAdConfig.PROVIDER_ADMOB);
        QtsAdjust.pushTrackEventAdmob(adValue);
        QtsAppsflyer.getInstance().pushTrackEventAdmob(adValue, adUnitId, adType);
    ...
    public static void logPaidAdImpression(Context context, MaxAd adValue, AdType adType) {
        ...
        QtsAdjust.pushTrackEventApplovin(adValue, context);
        QtsAppsflyer.getInstance().pushTrackEventApplovin(adValue, adType);
    }
    ...
    private static void logPaidAdImpressionValue(Context context, double value, int precision, String adunitid, String network, int mediationProvider) {
        ...
        QtsAdjust.logPaidAdImpressionValue(value, "USD");
    ...
    public static void pushTrackEventApplovin(MaxAd ad, Context context) {
        QtsAdjust.pushTrackEventApplovin(ad, context);
    }
}
