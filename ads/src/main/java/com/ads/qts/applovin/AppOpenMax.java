...
public class AppOpenMax implements Application.ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    private QtsAdCallback QtsAdCallback;
    ...
    public void loadAdResumeMax(Application application, String appOpenAdId) {
        ...
        appOpenAd.setListener(new MaxAdListener() {
            ...
            public void onAdLoaded(MaxAd ad) {
                ...
                if (QtsAdCallback != null) {
                    QtsAdCallback.onAdLoaded();
                }
            }
            ...
            public void onAdLoadFailed(String adUnitId, MaxError error) {
                ...
                dismissDialogLoading();
                if (QtsAdCallback != null) {
                    QtsAdCallback.onAdFailedToLoad(new ApAdError(error));
                }
            }
            ...
            public void onAdDisplayFailed(MaxAd ad, MaxError error) {
                ...
                dismissDialogLoading();
                if (QtsAdCallback != null) {
                    QtsAdCallback.onAdFailedToShow(new ApAdError(error));
                }
            }
        });
        appOpenAd.loadAd();
    ...
    public void setAppOpenMaxCallback(QtsAdCallback QtsAdCallback) {
        this.QtsAdCallback = QtsAdCallback;
    }
        ...
        if (openAdSplash.isReady()) {
            ...
            openAdSplash.setRevenueListener(new MaxAdRevenueListener() {
                ...
                public void onAdRevenuePaid(MaxAd maxAd) {
                    QtsLogEventManager.logPaidAdImpression(context, maxAd, AdType.APP_OPEN);
                }
            });
            openAdSplash.showAd();
        } else {
