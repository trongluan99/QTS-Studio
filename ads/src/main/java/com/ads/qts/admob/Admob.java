...
import com.ads.qts.funtion.AdType;
import com.ads.qts.funtion.AdmobHelper;
...
public class Admob {
    ...
    public void onShowSplash(AppCompatActivity activity, AdCallback adListener) {
        ...
        mInterstitialSplash.setOnPaidEventListener(adValue -> {
            QtsLogEventManager.logPaidAdImpression(context,
                    adValue,
                    mInterstitialSplash.getAdUnitId(),
                    mInterstitialSplash.getResponseInfo()
                            .getMediationAdapterClassName(), AdType.INTERSTITIAL);
            if (tokenAdjust != null) {
                QtsLogEventManager.logPaidAdjustWithToken(adValue, mInterstitialSplash.getAdUnitId(), tokenAdjust);
            }
        });
        ...
        mInterstitialSplash.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                QtsLogEventManager.logClickAdsEvent(context, mInterstitialSplash.getAdUnitId());
            }
    ...
    public void showInterstitialAdByTimes(final Context context, InterstitialAd mInterstitialAd, final AdCallback callback) {
        ...
        mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                QtsLogEventManager.logClickAdsEvent(context, mInterstitialAd.getAdUnitId());
            }
        });
        ...
        try {
            ...
            adView.setAdListener(new AdListener() {
                ...
                public void onAdLoaded() {
                    ...
                    if (adView != null) {
                        adView.setOnPaidEventListener(adValue -> {
                            ...
                            if (tokenAdjust != null) {
                                QtsLogEventManager.logPaidAdjustWithToken(adValue, adView.getAdUnitId(), tokenAdjust);
                            }
                        });
                    }
                ...
                public void onAdClicked() {
                    ...
                    QtsLogEventManager.logClickAdsEvent(context, id);
                }
        ...
        AdLoader adLoader = new AdLoader.Builder(context, id)
                .forNativeAd(nativeAd -> {
                    ...
                    nativeAd.setOnPaidEventListener(adValue -> {
                        ...
                        if (tokenAdjust != null) {
                            QtsLogEventManager.logPaidAdjustWithToken(adValue, id, tokenAdjust);
                        }
                    });
                })
            ...
            public void onAdLoaded(@NonNull RewardedAd rewardedAd) {
                ...
                Admob.this.rewardedAd.setOnPaidEventListener(adValue -> {
                    QtsLogEventManager.logPaidAdImpression(context,
                            ...
                            , AdType.REWARDED);
                    if (tokenAdjust != null) {
                        QtsLogEventManager.logPaidAdjustWithToken(adValue, rewardedAd.getAdUnitId(), tokenAdjust);
                    }
                });
            }
        ...
        if (rewardedAd == null) {
            ...
            Admob.this.rewardedAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                ...
                public void onAdClicked() {
                    ...
                    if (disableAdResumeWhenClickAds)
                        AppOpenManager.getInstance().disableAdResumeByClickAction();
                    QtsLogEventManager.logClickAdsEvent(context, rewardedAd.getAdUnitId());
                }
            });
    ...
    public void showRewardInterstitial(final Activity activity, RewardedInterstitialAd rewardedInterstitialAd, final RewardCallback adCallback) {
        ...
        if (rewardedInterstitialAd == null) {
            ...
            rewardedInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                ...
                public void onAdClicked() {
                    super.onAdClicked();
                    QtsLogEventManager.logClickAdsEvent(activity, rewardedAd.getAdUnitId());
                    if (disableAdResumeWhenClickAds)
                        AppOpenManager.getInstance().disableAdResumeByClickAction();
                }
            });
                ...
                if (interstitialAd != null) {
                    ...
                    mInterSplashHigh1.setOnPaidEventListener(new OnPaidEventListener() {
                        ...
                        public void onPaidEvent(@NonNull AdValue adValue) {
                            ...
                            if (tokenAdjust != null) {
                                QtsLogEventManager.logPaidAdjustWithToken(adValue, mInterSplashHigh1.getAdUnitId(), tokenAdjust);
                            }
                        }
                    });
    ...
    private void onShowSplashHigh1(AppCompatActivity activity, AdCallback adListener) {
        ...
        mInterSplashHigh1.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                if (disableAdResumeWhenClickAds)
                    AppOpenManager.getInstance().disableAdResumeByClickAction();
                QtsLogEventManager.logClickAdsEvent(context, mInterSplashHigh1.getAdUnitId());
            }
                ...
                if (interstitialAd != null) {
                    ...
                    mInterSplashHigh2.setOnPaidEventListener(new OnPaidEventListener() {
                        ...
                        public void onPaidEvent(@NonNull AdValue adValue) {
                            ...
                            if (tokenAdjust != null) {
                                QtsLogEventManager.logPaidAdjustWithToken(adValue, mInterSplashHigh2.getAdUnitId(), tokenAdjust);
                            }
                        }
                    });
    ...
    private void onShowSplashHigh2(AppCompatActivity activity, AdCallback adListener) {
        ...
        mInterSplashHigh2.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                if (disableAdResumeWhenClickAds)
                    AppOpenManager.getInstance().disableAdResumeByClickAction();
                QtsLogEventManager.logClickAdsEvent(context, mInterSplashHigh2.getAdUnitId());
            }
                ...
                if (interstitialAd != null) {
                    ...
                    mInterSplashHigh3.setOnPaidEventListener(new OnPaidEventListener() {
                        ...
                        public void onPaidEvent(@NonNull AdValue adValue) {
                            ...
                            if (tokenAdjust != null) {
                                QtsLogEventManager.logPaidAdjustWithToken(adValue, mInterSplashHigh3.getAdUnitId(), tokenAdjust);
                            }
                        }
                    });
    ...
    private void onShowSplashHigh3(AppCompatActivity activity, AdCallback adListener) {
        ...
        mInterSplashHigh3.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                if (disableAdResumeWhenClickAds)
                    AppOpenManager.getInstance().disableAdResumeByClickAction();
                QtsLogEventManager.logClickAdsEvent(context, mInterSplashHigh3.getAdUnitId());
            }
                ...
                if (interstitialAd != null) {
                    ...
                    mInterSplashNormal.setOnPaidEventListener(new OnPaidEventListener() {
                        ...
                        public void onPaidEvent(@NonNull AdValue adValue) {
                            ...
                            if (tokenAdjust != null) {
                                QtsLogEventManager.logPaidAdjustWithToken(adValue, mInterSplashNormal.getAdUnitId(), tokenAdjust);
                            }
                        }
                    });
    ...
    public void onShowSplashNormal(AppCompatActivity activity, AdCallback adListener) {
        ...
        mInterSplashNormal.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                if (disableAdResumeWhenClickAds)
                    AppOpenManager.getInstance().disableAdResumeByClickAction();
                QtsLogEventManager.logClickAdsEvent(context, mInterSplashNormal.getAdUnitId());
            }
